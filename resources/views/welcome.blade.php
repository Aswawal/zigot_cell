    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod Zigot Cellr incididunt ut labore et dolore
              magna aliqua.
            </p>
            <ul>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              Jasa <b> Service</b> Hp - Laptop - Komputer dengan harga lebih murah. yang beralamat di kabupaten Nunukan| Servis kami bergaransi 1 bulan sampai dengan 3 bulan.
              <br>
              <br>
              <b>Zigot Cell</b> memberikan pelayanan service profesional dengan menyediakan sparepart berkualitas Original dan Bergaransi.
              <br>
              <br>
              Kami menjanjikan harga yang ditawarkan dapat bersaing dan tetap mengutamakan kualitas dari sparepart yang kami sediakan, <b>Zigot Cell</b> memberikan harga service yang murah dan terjangkau untuk mencakup seluruh kalangan pengguna Gadget.
              <br>
              <br>
            </p>
    ...
    <section id="faq" class="faq">
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li>
            <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Ac odio Zigot Cellr orci dapibus. Aliquam eleifend mi in nulla? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
